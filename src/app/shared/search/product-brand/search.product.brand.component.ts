...
@Component({
  selector: 'search-product-brand',
  templateUrl: './search.product.brand.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SearchProductBrandComponent),
      multi: true
    }
  ]
})
export class SearchProductBrandComponent implements ControlValueAccessor {
