...
export class ManufacturerListComponent implements OnInit {
  ...
  loadData() {
    ...
    this.manufacturerService.getAll(this.paginator ? this.paginator.pageIndex : this.pageNumber, this.paginator ? this.paginator.pageSize : this.pageSize).subscribe(data => {
